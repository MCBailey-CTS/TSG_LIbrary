...
namespace TSG_Library.UFuncs.Mirror.Rules
{
    public abstract class BaseMirrorRule : IMirrorRule
    {
        ...
        public abstract SelectionIntentRule Mirror(SelectionIntentRule originalRule, Feature originalFeature,
        ...
        public static SelectionIntentRule MirrorRule(SelectionIntentRule originalRule, Feature originalFeature,
            Surface.Plane plane, Component originalComp, IDictionary<TaggedObject, TaggedObject> dict)
        {
                ...
                switch (originalRule.Type)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            $"Unknown rule: \"{originalRule.Type}\", for feature: {feature.GetFeatureName()} in part {feature.OwningPart.Leaf}");
                }
            }
