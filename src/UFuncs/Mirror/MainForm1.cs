    ...
    public class MainForm : Form
    {
                ...
                if (text2 == text3)
                {
                    if (File.Exists(fullPath))
                    {
                        ...
                        Component component = __work_part_.ComponentAssembly.AddComponent(partToAdd, "BODY",
                            _formatCompName, position, orientation, layer, out loadStatus2);
                        loadStatus2.Dispose();
        ...
        private Tag NewMethod27(Tag selectedPlane)
        {
            ...
            CartesianCoordinateSystem cartesianCoordinateSystem =
                __display_part_.CoordinateSystems.CreateCoordinateSystem(__display_part_.WCS.Origin,
        ...
        private static void NewMethod1(BlockFeatureBuilder blockFeatureBuilder1)
        {
            ...
            Point point = __work_part_.Points.CreatePoint(origin);
        ...
        private void NewMethod8(double[] mirrorMatrix, List<Tag> mirrorMove, BlockFeatureBuilder blockFeatureBuilder2)
        {
            ...
            Vector3d axisX = val.__AxisX();
            Vector3d axisY = val.__AxisY();
            Point point = __work_part_.Points.CreatePoint(origin2);
        ...
        public static DatumPlane SelectMirrorDatumPlane()
        {
            ...
            Selection.Response response = uisession_.SelectionManager.SelectTaggedObject("Select Datum Plane",
                "Select Datum Plane", Selection.SelectionScope.AnyInAssembly,
                Selection.SelectionAction.ClearAndEnableSpecific, false, false, maskArray, out @object, out cursor);
        ...
        public static TaggedObject[] SelectMultipleComponentBodies()
        {
            ...
            Selection.Response response = uisession_.SelectionManager.SelectTaggedObjects("Select Component",
                "Select Component", Selection.SelectionScope.AnyInAssembly,
                Selection.SelectionAction.ClearAndEnableSpecific, false, false, maskArray, out objectArray);
        ...
        private void InitializeComponent()
        {
            ...
            buttonSelectComponents.Location = new System.Drawing.Point(18, 12);
            ...
            textBoxDetNumber.Location = new System.Drawing.Point(59, 49);
            ...
            checkBoxMirrorCopies.Location = new System.Drawing.Point(6, 19);
            ...
            buttonExit.Location = new System.Drawing.Point(18, 127);
            ...
            buttonOk.Location = new System.Drawing.Point(110, 127);
