namespace TSG_Library.Extensions
{
    public static partial class Extensions_
    {
        ...
        //language=regexp
        /// <summary>The regular expression pattern that matches a metric dowel (dwl).
        ///     <para />
        /// </summary>
        /// <remarks>Expressions = "^(?&lt;diameter&gt;\d+)mm-dwl-(?&lt;length&gt;\d+)$"</remarks>
        /// <list type="number">
        ...
        #region Tag AssemblyColorCodeType and Subtypes
